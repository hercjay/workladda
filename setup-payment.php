...
<head>
	...
	<title>Setup Payment - WorkLadda</title>
</head>
<body>
			...
			<div class="container">
				...
				<div class="row m-1 d-flex justify-content-center shadowCardBG p-2">
					...
					<div class="col-lg-6 col-md-6  shadowCard p-4 m-2">
						<h2><strong>PAYMENT DETAILS SETUP SUCCESSFUL!</strong></h2> 
						<img src="images/doneG2.svg" class="img-fluid mb-4 p-2">
						<h4>
							Your request to update your payment details has been submitted successfully.
						</h4> <br/>
